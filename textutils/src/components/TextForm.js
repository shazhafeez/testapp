...
export default function TextForm(props) {
  ...
  <button class="btn btn-primary mx-2" onClick={HandleOnClick} >change to upperCase</button>
  <button class="btn btn-primary mx-2" onClick={HandleLoClick} >change to LowerCase</button>
  <button class="btn btn-primary mx-2" onClick={vowelCount}  >CLick to find number of vowels</button>
...
<div className="container my-3" style={{color: props.Mode === 'dark'?'white':'#152f49'}}>
  ...
  <p>{0.08*Text.split(" ").length} time taken to read</p>
